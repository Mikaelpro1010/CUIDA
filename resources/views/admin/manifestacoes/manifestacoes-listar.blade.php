...
<div>
    ...
    <form class="" action="{{ route('get-list-manifestacoes2') }}" method="GET" id="filtroCanaisMensagem">
        <div class="m-0 p-0 row">
            ...
            <div class="col-md-2">
                ...
                <input id="data-inicio" class="form-control" type="date" name="data_inicio" max="{{ dateAndFormat() }}"
                    value="@if (request()->data_inicio){{ formatarDataHora(request()->data_inicio) }}@endif">
            </div>
            <div class="col-md-2">
                <label for="data-fim">Data Fim:</label>
                <input id="data-fim" class="form-control" type="date" name="data_fim" max="{{ dateAndFormat() }}"
                    value="@if (request()->data_fim){{ formatarDataHora(request()->data_fim) }}@endif">
            </div>
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    ...
                    <td class=" text-center">
                        <a href="{{ route('get-view-manifestacao2', $manifestacao->id) }}" class="btn btn-primary">
