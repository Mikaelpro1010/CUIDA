        ...
        <div class="accordion accordion-flush" id="compartilhamento">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="flush-headingOne">
                    <div>
                        <button class="border accordion-button collapsed" type="button" data-bs-toggle="collapse"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="form_enviar_resposta_compartilhamento_{{ $compartilhamento->id }}"
                                action="{{ route('responder-compartilhamento', $compartilhamento) }}" method="POST">
                                {{ csrf_field() }}
                                <p>Responda o compartilhamento desta manifestação:</p>
                                <textarea class="mb-3 form-control" name="resposta" placeholder="Mensagem*"
                                    rows="5"></textarea>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="" action="{{ route('compartilhar-manifestacao', $manifestacao->id) }}"
                                ...
                                <textarea class="mb-3 form-control" name="texto_compartilhamento"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        (Resposta Vazia)
                        @else
                        {{ $prorrogacao->resposta }}
                        @endif
                    </td>
                    <td>
                        {{ App\Models\Prorrogacao::SITUACAO_NOME[$prorrogacao->situacao] }}
                    ...
                    <td>
                        ...
                        <button class="btn btn-primary button_open_resposta_prorrogacao"
                            data-id="{{ $prorrogacao->id }}">
                            Responder
                        </button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="form_enviar_resposta_prorrogacao_{{ $prorrogacao->id }}" class=""
                                            ...
                                            <textarea class="mt-3 mb-3 form-control" name="resposta"
                                                placeholder="Mensagem*" id="descricao" rows="5"></textarea>
                                            {{ csrf_field() }}
                                            <div class="modal-footer">
                                                <button type="submit"
                                                    class="btn btn-success button_enviar_resposta_prorrogacao"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="" action="{{ route('criar-prorrogacao', $manifestacao->id) }}" method="POST">
                            ...
                            <textarea name="motivo_solicitacao" class="mb-3 form-control" name="mensagem"
                                placeholder="Mensagem*" id="descricao" rows="5"></textarea>
                            {{ csrf_field() }}
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-success"
