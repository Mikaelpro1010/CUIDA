                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="form_enviar_resposta_compartilhamento_{{ $compartilhamento->id }}"
                                        action="{{ route('responder-compartilhamento', $compartilhamento) }}"
                                        method="POST">
                                        {{ csrf_field() }}
                                    ...
                                    <form class=""
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-success"
                                                id="button_close_compartilhamento">Compartilhar
                                            </button>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($prorrogacao->situacao == App\Models\Prorrogacao::SITUACAO_ESPERA)
                                        ...
                                        <div id="Modal_resposta_prorrogacao_{{ $prorrogacao->id }}" name="id"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form id="form_enviar_resposta_prorrogacao_{{ $prorrogacao->id }}"
                                                            class=""
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#recurso-{{ $recurso->id }}" aria-expanded="true"
                                    aria-controls="#recurso-{{ $recurso->id }}">
                                    {{ $key + 1 }}º Recurso
                                </button>
                            </h2>
