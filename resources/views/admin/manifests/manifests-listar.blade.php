...
<div>
    <div class="d-sm-grid d-md-flex justify-content-between d-flex align-items-center">
        <h1 class="text-primary">Manifestações</h1>
    </div>
    <hr>

    <form class="" action="{{ route('get-list-manifestacoes') }}" method="GET" id="filtroCanaisMensagem">
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    ...
                    <td class=" text-center">
                        <a href="{{ route('get-view-manifestacao', $manifestacao->id) }}" class="btn btn-primary">
