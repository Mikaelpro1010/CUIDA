        ...
        <div class=" p-3">
            <div class="d-flex justify-content-between align-items-end">
                ...
                <div class="text-center text-success">
                    <i class="@if ($avaliacoesAverage > 8) fa-6x @else fa-4x @endif fa-regular fa-face-laugh-beam"></i>
                    <br>
                    <span>Muito Bom</span>
                </div>
            </div>
            <div class="mt-2 progress">
                <div id="avaliacaoGeral" class="progress-bar progress-bar-striped progress-bar-animated
