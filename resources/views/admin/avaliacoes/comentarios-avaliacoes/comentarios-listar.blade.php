...
<form class="" action="{{ route('get-comentarios-avaliacoes-list') }}" method="GET">
    ...
    <div class="d-flex flex-wrap gap-2">
        ...
        <div
            class="flex-grow-1 @if (is_null(request()->secretaria_pesq) && is_null(request()->tipo_avaliacao)) d-none @endif">
        ...
        <div
            class="flex-fill @if (is_null(request()->secretaria_pesq) && is_null(request()->unidade_pesq)) d-none @endif">
...
<div class="table-responsive">
    <table class="table table-sm table-striped mt-3 align-middle">
        ...
        <tbody class="table-group-divider">
            ...
            <tr>
                <td>
                    {{ $avaliacao->setor->unidade->secretaria->sigla . ' - ' .
                    $avaliacao->setor->unidade->secretaria->nome }}
                </td>
                <td>
...
<script nonce="{{ app('csp-nonce') }}">
    ...
    $('#exportar').click(function(e){
       ...
       window.open(url + '?pesquisa_unidade_setor=' + pesquisa_unidade_setor + '&pesq_nota=' + pesq_nota + '&secretaria_pesq=' + secretaria_pesq + '&tipo_avaliacao=' + tipo_avaliacao + '&unidade_pesq=' + unidade_pesq + '&setor_pesq=' + setor_pesq + '&data_inicial=' + data_inicial + '&data_final=' + data_final, '_blank')
    });
