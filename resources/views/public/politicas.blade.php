...
<hr>
<p>
    A sua privacidade é importante para nós. É política do Escuta Sol respeitar a sua privacidade em relação a qualquer
    informação sua que possamos coletar no site e aplicativo <a href={{ env('APP_URL') }} />Escuta Sol</a>, e outros
...
<p>
    O uso continuado de nosso site será considerado como aceitação de nossas práticas em torno de Aviso de Privacidade e
    informações pessoais. Se você tiver alguma dúvida sobre como lidamos com dados do usuário e informações pessoais,
    entre em contato conosco.
</p>

<h2>Política de Cookies Escuta Sol</h2>
...
<p>
    ...
    esses cookies sejam armazenados, no entanto, isso pode prejudicar a funcionalidade do site.
</p>
...
<ul>
    <li>
        ...
        <br><br>
        Se você criar uma conta conosco, usaremos cookies para o gerenciamento do processo de inscrição e administração
    ...
    <li>
        ...
        fazer login sempre que visitar uma nova página. Esses cookies são normalmente removidos ou limpos quando você
        efetua logout para garantir que você possa acessar apenas a recursos e áreas restritas ao efetuar login.
        <br><br>
    </li>
    <li>
        ...
        de comentários, os cookies podem ser configurados para lembrar os detalhes do usuário para correspondência
        futura.
        <br><br>
    </li>
    <li>
        ...
        que essas informações possam ser chamadas sempre que você interagir com uma página for afetada por suas
        preferências.
        <br>
    </li>
</ul>
...
<p>
    O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Escuta Sol oferece no site e com
...
<ul>
    ...
    <li>
        C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Escuta Sol, de seus fornecedores
