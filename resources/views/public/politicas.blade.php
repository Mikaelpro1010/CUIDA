...
@section('content')
    ...
    <hr>
    <p>
        A sua privacidade é importante para nós. É política do EscutaSol respeitar a sua privacidade em relação a qualquer
        informação sua que possamos coletar no site e aplicativo <a href={{ env('APP_URL') }} />EscutaSol</a>, e outros
    ...
    <h2>Política de Cookies EscutaSol</h2>
    ...
    <p>
        O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o EscutaSol oferece no site e com
    ...
    <ul>
        ...
        <li>
            C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do EscutaSol, de seus fornecedores
