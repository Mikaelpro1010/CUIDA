                            ...
                            <div class="row align-items-start">
                                <div class="col-2">
                                    <figure class="figure p-2">
                                        <img src="{{ asset('imgs/support.jpg') }}" class="figure-img img-fluid rounded" alt="">
                                    </figure>
                                </div>
                                <div class="col-10">
                    ...
                    <div class="p-4 rounded-2 bg-secondary col">
                        <div class="row align-items-start">
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="col-2">
                                    <figure class="figure p-2">
                                        <img src="{{ asset('imgs/pesquisa.jpg') }}" class="figure-img img-fluid rounded" alt="">
                                    </figure>
                                </div>
                                <div class="col-10">
        ...
        <div class="col-md-6">
            ...
            <div class="border card-body">
                <div class="row mt-1 p-2 border">
                    <p>
                        <img src="{{ asset('imgs/emoji_pensativo.jpg') }}" class="border figure-img img-fluid rounded"
                ...
                <div class="row mt-2 border p-2">
                    <p>
                        <img src="{{ asset('imgs/emoji_ideia.jpg') }}" class="border figure-img img-fluid rounded"
                        alt="60" width="60" height="60">
                ...
                <div class="row mt-2 border p-2">
                    <p>
                        <img src="{{ asset('imgs/emoji_elogio1.jpg') }}" class="border figure-img img-fluid rounded"
                        alt="60" width="60" height="60">
                ...
                <div class="row mt-2 border p-2">
                    <p>
                        <img src="{{ asset('imgs/pedido.png') }}" class="figure-img img-fluid rounded border"
                ...
                <div class="row mt-2 border p-2">
                    <p>
                        <img src="{{ asset('imgs/emoji_reclamacao.jpg') }}" class="figure-img img-fluid rounded border"
                ...
                <div class="row mt-2 border p-2">
                    <p>
                        <img src="{{ asset('imgs/denuncia.jpg') }}" class="figure-img img-fluid rounded"
                        alt="40" width="40" height="40">
